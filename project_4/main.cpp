...
const std::string MEMBERS_FILE    = "/Users/kangsirui/Desktop/proj4vscode/members.txt";
const std::string TRANSLATOR_FILE = "/Users/kangsirui/Desktop/proj4vscode/translator.txt";
